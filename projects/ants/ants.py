...
class Ant(Insect):
    ...
    def __init__(self, health=1):
        ...
        self.doubled_damage = False   # Problem 12
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        for _ in range(lower_bound) :
            if place.entrance.is_hive == True:
               return None
            else:
        ...
        if upper_bound == lower_bound:
            ...
            while index > 0 and place.is_hive == False:
                if place.bees:
                    return random_bee(place.bees) 
                else:
                    place = place.entrance
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        if self.health - amount <= 0:
            ...
            self.doubled_damage = True     # this line for Problem 12
        ...
        if self.place.bees:
            ...
            for bee in self.place.bees[:]:
                ...
                if bee.health > 0:
                    remaind_bee.append(bee)
            self.place.bees = remaind_bee
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        if self.turns_to_chew == 0 and self.place.bees:
            killed_bee = random_bee(self.place.bees)
    ...
    def action(self, gamestate):
        ...
        while current_place is not None:
            if current_place.ant:
                if isinstance(current_place.ant,ContainerAnt) and current_place.ant.ant_contained is not None and current_place.ant.ant_contained.doubled_damage == False:
                    current_place.ant.ant_contained.double()
                    self.doubled_ants.add(current_place.ant.ant_contained)   
                if current_place.ant not in self.doubled_ants and current_place.ant.doubled_damage == False: 
                    current_place.ant.double()   
                    self.doubled_ants.add(current_place.ant)  
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self):
        ...
        while place.is_hive == False:
            ...
            if self.place.ant:
                dic[place.ant] = i
                if isinstance(place.ant,ContainerAnt) and place.ant.ant_contained is not None:
                    dic[place.ant.ant_contained] = i
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 2
        damage = max(0, self.damage - 0.25 * distance)
        self.damage  -= 0.0625
        return damage
        # END Problem Optional 2
